...
import { PieChart, List, Sparkles, ClipboardList, BookOpen, TrendingUp, Upload, Settings, Receipt, Eye } from 'lucide-react';
...
const mainNav: { id: TabType; label: string; icon: React.ElementType; desc: string }[] = [
  ...
  { id: 'transactions',  label: '操作记录', icon: Receipt,    desc: '买卖与导入'  },
  { id: 'ai',            label: 'AI 评估',  icon: Sparkles,   desc: '智能分析'    },
  { id: 'rebalance',     label: '行动计划', icon: ClipboardList, desc: '下步操作' },
